...
public abstract class Error {
  ...
  // Statements
    public static void Print_statement(Token t) {
    Err(t, "*****This is a test print*******");
  }
  ...
  // Values/Functions
  public static void FunctionRedefinition(Token t, Value.Function func) {
    Err(t, "redefinition of " + func.id);
  }
