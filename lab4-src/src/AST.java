...
public abstract class AST {
  ...
  public static class Print implements Visitor<Void> {
    ...
    @Override
    public Void visit(Value.ScalarAccess sAccess) {
      say(sAccess.id);
      return null;
    }
  ...
  public static abstract class Statement extends Node {
    ...
    public static class CompoundStatement extends Statement {
      ...
      public Scope scope;
      public CompoundStatement(Token id, List<Statement> stmtList, Scope scope) {
        super(id);
    ...
    public static class CallStatement extends Statement {
      ...
      public CallStatement(Token id, Expression callExpr) 
      {
        super(id);
  ...
  public static abstract class Value extends Node {
    ...
    public static abstract class VarAccess extends Value {
      VarAccess(Token id) {
        super(id);
      }
    }

    public static class ScalarAccess extends VarAccess {
      public Token id;
      public Value.Type type;
      
      public ScalarAccess(Token id) {
        super(id);
        this.id = id;
      }
      public <T> T accept(Visitor<T> visitor) { return visitor.visit(this); }
